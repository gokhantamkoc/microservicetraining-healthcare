package com.gokhantamkoc.microservicetraining.healthcare.notification.adapter.out.grpc;
...
public class PatientPhysicianGrpcClient {
    ...
    public PatientSummary getPatient(Long patientId) {
        ...
        return new PatientSummary(Long.valueOf(reply.getPatientId()), reply.getFullName(), reply.getPhoneNumber());
    }
    ...
    public PhysicianSummary getPhysician(Long physicianId) {
        ...
        return new PhysicianSummary(Long.valueOf(reply.getPhysicianId()), reply.getFullName(), reply.getSpecialty());
    }
    ...
    public CompletableFuture<PatientSummary> getPatientAsync(Long patientId) {
        ...
        patientAsyncStub.getPatient(PatientRequest.newBuilder().setPatientId(String.valueOf(patientId)).build(), new StreamObserver<>() {
            ...
            public void onNext(PatientReply reply) {
                ...
                future.complete(new PatientSummary(Long.valueOf(reply.getPatientId()), reply.getFullName(), reply.getPhoneNumber()));
            }
    ...
    public CompletableFuture<PhysicianSummary> getPhysicianAsync(Long physicianId) {
        ...
        physicianAsyncStub.getPhysician(PhysicianRequest.newBuilder().setPhysicianId(String.valueOf(physicianId)).build(), new StreamObserver<>() {
            ...
            public void onNext(PhysicianReply reply) {
                ...
                future.complete(new PhysicianSummary(Long.valueOf(reply.getPhysicianId()), reply.getFullName(), reply.getSpecialty()));
            }
    ...
    public record PatientSummary(Long id, String fullName, String phoneNumber) {
    }

    public record PhysicianSummary(Long id, String fullName, String specialty) {
    }
}
